...
description: First-time setup flow for project-translate preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.baoyu-skills/project-translate/EXTEND.md` | All projects |
| Project | `.baoyu-skills/project-translate/EXTEND.md` | Current project |
