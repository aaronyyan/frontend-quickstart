...
test -f .baoyu-skills/project-translate/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/baoyu-skills/project-translate/EXTEND.md" && echo "xdg"
test -f "$HOME/.baoyu-skills/project-translate/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .baoyu-skills/project-translate/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/baoyu-skills/project-translate/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.baoyu-skills/project-translate/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.baoyu-skills/project-translate/EXTEND.md` | Project directory |
| `$HOME/.baoyu-skills/project-translate/EXTEND.md` | User home |
